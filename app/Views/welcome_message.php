...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            <h1>Form Pendaftaran Lomba 17'an Kelurahan Grendeng Purwokerto Utara</h1>
        </div>
        ...
        <form action="<?php echo site_url('simpan-peserta'); ?>" method="POST">
            ...
            <div style="width: 100%; margin: 5px;">
                ...
                <select name="jenis_lomba" id="jenis_lomba" class="form-input">
                    ...
                    <option value="4">Tangkap Belut, Lari Kelereng</option>
                    <option value="5">Lari Kelereng</option>
                </select>
            </div>
            <div style="width: 100%; margin: 5px;">
